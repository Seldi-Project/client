...
export default function Certification() {
  const vacState1 = true;  //test
  const vacState2 = false;  //test
  ...
  return (
    <div className="component" id="certificationComponent">
      ...
      <div id="certifications" style={{"transform":`translateX(${certStyle})`}}>
        <div className="certification" style={{"opacity":`${vacState2 || 0.4}`}} onClick={() => changeSelect(2)}>
          <Cert2/>
        </div>
        
        <div className="certification" style={{"opacity":`${vacState1 || 0.4}`}} onClick={() => changeSelect(1)}>
          <Cert1/>
        </div>
      </div>
    </div>
